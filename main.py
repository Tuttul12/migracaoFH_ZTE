...
df = pd.read_csv('PON trilhas-4 - Página1.csv')
...
def bridge():
    ...
    print(retorno)
    time.sleep(0.1)
    tn.write(b"interface gpon-olt_1/5/" + pon_ + b"\n")
    time.sleep(0.1)
    tn.write(b"onu " + num_ + b" type F601 sn " + sn_ + b"\n")
    tn.write(b"exit \n")
    time.sleep(0.1)
    tn.write(b"interface gpon-onu_1/5/" + pon_ + b":" + num_ + b"\n")
    time.sleep(0.1)
    ...
    tn.write(b"exit \n")
    time.sleep(0.1)
    tn.write(b"pon-onu-mng gpon-onu_1/5/" + pon_ + b":" + num_ + b"\n")
    time.sleep(0.1)
